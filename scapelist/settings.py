...
# Django settings for scapelist project.
...
SECRET_KEY = '4!w!+d_=-%1x21iwx9xl1$!j*c&4d9fbx*a!)su*kv^jz9$ako'
...
ROOT_URLCONF = 'scapelist.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'scapelist.wsgi.application'
